  ...
  <body>
	<div class="layout-admin">
		<header class="layout-header">
			<span class="header-logo">博客后台管理</span> 
			...
			<div class="layout-main-tab">
                ...
                <nav class="tab-nav">
                    <div class="tab-nav-content">
                        <a href="javascript:;" class="content-tab active" data-id="/manage/hom">首页</a>
                    </div>
                </nav>
                <button class="tab-btn btn-right"><i class="icon-font">&#xe60f;</i></button>
			</div>
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="/manage/hom" frameborder="0" data-id="/manage/hom" seamless></iframe>
			</div>
		</section>
